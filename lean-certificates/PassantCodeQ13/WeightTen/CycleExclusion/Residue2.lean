...
pair of its secant neighbours whose lower endpoint has coordinate index congruent to 2 modulo
...
namespace PassantCodeQ13.WeightTen.CycleExclusion.Residue2
...
theorem shard_obstructed : shardObstructed 2 = true := by
  decide +kernel

end PassantCodeQ13.WeightTen.CycleExclusion.Residue2
