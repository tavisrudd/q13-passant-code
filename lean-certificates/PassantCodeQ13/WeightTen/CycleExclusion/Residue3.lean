...
pair of its secant neighbours whose lower endpoint has coordinate index congruent to 3 modulo
...
namespace PassantCodeQ13.WeightTen.CycleExclusion.Residue3
...
theorem shard_obstructed : shardObstructed 3 = true := by
  decide +kernel

end PassantCodeQ13.WeightTen.CycleExclusion.Residue3
