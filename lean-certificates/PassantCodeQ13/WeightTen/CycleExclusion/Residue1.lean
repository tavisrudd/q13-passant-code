...
pair of its secant neighbours whose lower endpoint has coordinate index congruent to 1 modulo
...
namespace PassantCodeQ13.WeightTen.CycleExclusion.Residue1
...
theorem shard_obstructed : shardObstructed 1 = true := by
  decide +kernel

end PassantCodeQ13.WeightTen.CycleExclusion.Residue1
