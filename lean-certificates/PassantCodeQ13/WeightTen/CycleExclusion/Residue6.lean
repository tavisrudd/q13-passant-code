...
pair of its secant neighbours whose lower endpoint has coordinate index congruent to 6 modulo
...
namespace PassantCodeQ13.WeightTen.CycleExclusion.Residue6
...
theorem shard_obstructed : shardObstructed 6 = true := by
  decide +kernel

end PassantCodeQ13.WeightTen.CycleExclusion.Residue6
