...
pair of its secant neighbours whose lower endpoint has coordinate index congruent to 5 modulo
...
namespace PassantCodeQ13.WeightTen.CycleExclusion.Residue5
...
theorem shard_obstructed : shardObstructed 5 = true := by
  decide +kernel

end PassantCodeQ13.WeightTen.CycleExclusion.Residue5
