...
pair of its secant neighbours whose lower endpoint has coordinate index congruent to 4 modulo
...
namespace PassantCodeQ13.WeightTen.CycleExclusion.Residue4
...
theorem shard_obstructed : shardObstructed 4 = true := by
  decide +kernel

end PassantCodeQ13.WeightTen.CycleExclusion.Residue4
