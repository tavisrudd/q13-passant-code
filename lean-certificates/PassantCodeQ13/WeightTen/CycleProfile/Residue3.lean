...
is congruent to 3 modulo seven.  Native evaluation checks the shard against the common 216-value
left syndrome image. -/
...
/-- The cycle-profile residue-3 shard has no zero-syndrome support. -/
theorem residue3_syndrome_disjoint : cycleProfileCheck 3 = true := by
  native_decide
