...
is congruent to 0 modulo seven.  Native evaluation checks the shard against the common 216-value
left syndrome image. -/
...
/-- The cycle-profile residue-0 shard has no zero-syndrome support. -/
theorem residue0_syndrome_disjoint : cycleProfileCheck 0 = true := by
  native_decide
