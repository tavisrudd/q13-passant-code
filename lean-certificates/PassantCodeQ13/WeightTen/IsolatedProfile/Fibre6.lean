...
index 6 in the normalized list.  Native evaluation checks disjointness of all 216 left and 4320
...
/-- The isolated profile with distinguished fibre 6 has no zero-syndrome support. -/
theorem fibre6_syndrome_disjoint : isolatedProfileCheck 6 = true := by
  native_decide
