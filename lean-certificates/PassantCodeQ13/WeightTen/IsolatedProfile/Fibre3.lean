...
index 3 in the normalized list.  Native evaluation checks disjointness of all 216 left and 4320
...
/-- The isolated profile with distinguished fibre 3 has no zero-syndrome support. -/
theorem fibre3_syndrome_disjoint : isolatedProfileCheck 3 = true := by
  native_decide
