...
index 0 in the normalized list.  Native evaluation checks disjointness of all 216 left and 4320
...
/-- The isolated profile with distinguished fibre 0 has no zero-syndrome support. -/
theorem fibre0_syndrome_disjoint : isolatedProfileCheck 0 = true := by
  native_decide
