...
index 4 in the normalized list.  Native evaluation checks disjointness of all 216 left and 4320
...
/-- The isolated profile with distinguished fibre 4 has no zero-syndrome support. -/
theorem fibre4_syndrome_disjoint : isolatedProfileCheck 4 = true := by
  native_decide
