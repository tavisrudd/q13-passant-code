import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.LeftOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.RightOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.LeftOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.LeftOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.LeftOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.Base
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.DistinguishedTriple
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.RightOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.RightOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.RightOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.TerminalDisjoint.FirstThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.TerminalDisjoint.MiddleThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.TerminalDisjoint.LastThird
...
two sides of the meet-in-the-middle decomposition for distinguished passant fibre 4.
...
namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4
...
theorem left_chain : chainCheck [0] (isolatedLeftOptions 4) leftLayers = true := by
...
theorem right_chain : chainCheck [0] (isolatedRightOptions 4) rightLayers = true := by
...
theorem no_equal_cartesian_syndromes
    ...
    (leftChoices : ChoicePath (isolatedLeftOptions 4) leftPath)
    (rightChoices : ChoicePath (isolatedRightOptions 4) rightPath) :
...
theorem no_equal_of_mem_choices
    {leftPath rightPath : List Nat}
    (left_mem : leftPath ∈ choices (isolatedLeftOptions 4))
    (right_mem : rightPath ∈ choices (isolatedRightOptions 4)) :
    leftPath.foldl (fun state increment => state ^^^ increment) 0 ≠
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4
