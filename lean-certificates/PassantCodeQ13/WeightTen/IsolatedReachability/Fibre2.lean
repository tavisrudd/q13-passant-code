import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.LeftOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.RightOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.LeftOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.LeftOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.LeftOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.Base
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.DistinguishedTriple
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.RightOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.RightOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.RightOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.TerminalDisjoint.FirstThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.TerminalDisjoint.MiddleThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.TerminalDisjoint.LastThird
...
two sides of the meet-in-the-middle decomposition for distinguished passant fibre 2.
...
namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2
...
theorem left_chain : chainCheck [0] (isolatedLeftOptions 2) leftLayers = true := by
...
theorem right_chain : chainCheck [0] (isolatedRightOptions 2) rightLayers = true := by
...
theorem no_equal_cartesian_syndromes
    ...
    (leftChoices : ChoicePath (isolatedLeftOptions 2) leftPath)
    (rightChoices : ChoicePath (isolatedRightOptions 2) rightPath) :
...
theorem no_equal_of_mem_choices
    {leftPath rightPath : List Nat}
    (left_mem : leftPath ∈ choices (isolatedLeftOptions 2))
    (right_mem : rightPath ∈ choices (isolatedRightOptions 2)) :
    leftPath.foldl (fun state increment => state ^^^ increment) 0 ≠
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2
