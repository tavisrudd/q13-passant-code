...
the compact syndrome-increment lists for distinguished passant fibre 6 agree with the
normalized conic incidence columns used by the formal Cartesian domain.
-/

namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.RightOptions
...
theorem checked : isolatedRightOptions 6 = PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre6.rightOptions := by
  unfold PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre6.rightOptions
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.RightOptions
