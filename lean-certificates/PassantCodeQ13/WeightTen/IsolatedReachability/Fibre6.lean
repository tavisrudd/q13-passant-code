import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.LeftOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.RightOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.LeftOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.LeftOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.LeftOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.Base
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.DistinguishedTriple
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.RightOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.RightOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.RightOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.TerminalDisjoint.FirstThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.TerminalDisjoint.MiddleThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6.TerminalDisjoint.LastThird
...
two sides of the meet-in-the-middle decomposition for distinguished passant fibre 6.
...
namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6
...
theorem left_chain : chainCheck [0] (isolatedLeftOptions 6) leftLayers = true := by
...
theorem right_chain : chainCheck [0] (isolatedRightOptions 6) rightLayers = true := by
...
theorem no_equal_cartesian_syndromes
    ...
    (leftChoices : ChoicePath (isolatedLeftOptions 6) leftPath)
    (rightChoices : ChoicePath (isolatedRightOptions 6) rightPath) :
...
theorem no_equal_of_mem_choices
    {leftPath rightPath : List Nat}
    (left_mem : leftPath ∈ choices (isolatedLeftOptions 6))
    (right_mem : rightPath ∈ choices (isolatedRightOptions 6)) :
    leftPath.foldl (fun state increment => state ^^^ increment) 0 ≠
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre6
