...
the compact syndrome-increment lists for distinguished passant fibre 3 agree with the
normalized conic incidence columns used by the formal Cartesian domain.
-/

namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre3.RightOptions
...
theorem checked : isolatedRightOptions 3 = PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre3.rightOptions := by
  unfold PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre3.rightOptions
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre3.RightOptions
