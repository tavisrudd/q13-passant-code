import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.LeftOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.RightOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.LeftOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.LeftOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.LeftOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.Base
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.DistinguishedTriple
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.RightOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.RightOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.RightOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.TerminalDisjoint.FirstThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.TerminalDisjoint.MiddleThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1.TerminalDisjoint.LastThird
...
two sides of the meet-in-the-middle decomposition for distinguished passant fibre 1.
...
namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1
...
theorem left_chain : chainCheck [0] (isolatedLeftOptions 1) leftLayers = true := by
...
theorem right_chain : chainCheck [0] (isolatedRightOptions 1) rightLayers = true := by
...
theorem no_equal_cartesian_syndromes
    ...
    (leftChoices : ChoicePath (isolatedLeftOptions 1) leftPath)
    (rightChoices : ChoicePath (isolatedRightOptions 1) rightPath) :
...
theorem no_equal_of_mem_choices
    {leftPath rightPath : List Nat}
    (left_mem : leftPath ∈ choices (isolatedLeftOptions 1))
    (right_mem : rightPath ∈ choices (isolatedRightOptions 1)) :
    leftPath.foldl (fun state increment => state ^^^ increment) 0 ≠
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre1
