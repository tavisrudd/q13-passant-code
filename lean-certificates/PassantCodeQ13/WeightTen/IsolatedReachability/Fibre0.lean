import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.LeftOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.RightOptions
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.LeftOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.LeftOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.LeftOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.Base
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.DistinguishedTriple
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.RightOrdinaryA
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.RightOrdinaryB
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.RightOrdinaryC
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.TerminalDisjoint.FirstThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.TerminalDisjoint.MiddleThird
import PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.TerminalDisjoint.LastThird
...
two sides of the meet-in-the-middle decomposition for distinguished passant fibre 0.
...
namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0
...
theorem left_chain : chainCheck [0] (isolatedLeftOptions 0) leftLayers = true := by
...
theorem right_chain : chainCheck [0] (isolatedRightOptions 0) rightLayers = true := by
...
theorem no_equal_cartesian_syndromes
    ...
    (leftChoices : ChoicePath (isolatedLeftOptions 0) leftPath)
    (rightChoices : ChoicePath (isolatedRightOptions 0) rightPath) :
...
theorem no_equal_of_mem_choices
    {leftPath rightPath : List Nat}
    (left_mem : leftPath ∈ choices (isolatedLeftOptions 0))
    (right_mem : rightPath ∈ choices (isolatedRightOptions 0)) :
    leftPath.foldl (fun state increment => state ^^^ increment) 0 ≠
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0
