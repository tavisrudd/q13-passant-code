...
the compact syndrome-increment lists for distinguished passant fibre 0 agree with the
normalized conic incidence columns used by the formal Cartesian domain.
-/

namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.RightOptions
...
theorem checked : isolatedRightOptions 0 = PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre0.rightOptions := by
  unfold PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre0.rightOptions
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre0.RightOptions
