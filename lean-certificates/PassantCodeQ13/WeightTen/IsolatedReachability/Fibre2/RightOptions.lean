...
the compact syndrome-increment lists for distinguished passant fibre 2 agree with the
normalized conic incidence columns used by the formal Cartesian domain.
-/

namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.RightOptions
...
theorem checked : isolatedRightOptions 2 = PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre2.rightOptions := by
  unfold PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre2.rightOptions
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre2.RightOptions
