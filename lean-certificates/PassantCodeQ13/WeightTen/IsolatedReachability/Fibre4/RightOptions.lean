...
the compact syndrome-increment lists for distinguished passant fibre 4 agree with the
normalized conic incidence columns used by the formal Cartesian domain.
-/

namespace PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.RightOptions
...
theorem checked : isolatedRightOptions 4 = PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre4.rightOptions := by
  unfold PassantCodeQ13.WeightTen.ReachabilityData.IsolatedFibre4.rightOptions
...
end PassantCodeQ13.WeightTen.IsolatedReachability.Fibre4.RightOptions
